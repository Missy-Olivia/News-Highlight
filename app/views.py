...
def index():
    ...
    return render_template('home.html',title = title, business_sources = business_sources,sports_sources = sports_sources,tech_sources = tech_sources,entertainment_sources = entertainment_sources)
